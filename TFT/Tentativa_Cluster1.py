...
if __name__ == "__main__":
    ...
    try:
        ...
        # Faça isso ANTES de criar o X_y_df
        # Use uma janela de 7 ou 14 dias
        df_clean['Y_Target_Rolling_Vol_7D'] = df_clean[target_col].rolling(window=7, min_periods=1).std()

        # Agora, adicione essa nova feature na sua lista de features
        autoregressive_features.append('Y_Target_Rolling_Vol_7D')
        ...
        training_data = TimeSeriesDataSet(
            ...
            target_normalizer=GroupNormalizer(groups=["group"], transformation="softplus"), # <--- MUDE AQUI
